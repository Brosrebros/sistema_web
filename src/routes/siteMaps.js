...
import inmobiliariaImg from 'assets/icons/navbar-inmobiliaria.svg';
import inicioImg from 'assets/icons/navbar-inicio.svg';
import nosotrosImg from 'assets/icons/navbar-nosotros.svg';
import logisticaYTransporteImg from 'assets/img/icons/vehiculosytransportes_blanco.svg';


import industriaYMaquinariaImg from 'assets/img/icons/maquinariasyequipos_blanco.svg';
import inversionesYFinanzasImg from 'assets/img/icons/tecnologiayeletronica_blanco.svg';
import publicidadYMarketingImg from 'assets/img/icons/consumoyestilodevida_blanco.svg';
import comercioYProductosImg from 'assets/img/icons/inversionesyfinanzas_blanco.svg';
import empleosImg from 'assets/icons/navbar-empleos.svg';
import promocionesYEventosImg from 'assets/img/icons/eventos_blanco.svg';
import promociones from 'assets/img/icons/promociones_blanco.svg';
import tendencias from 'assets/img/icons/tendencias_blanco.svg';
import atencionAlClienteImg from 'assets/icons/navbar-atencionalcliente.svg';
import configuracionImg from 'assets/icons/navbar-configuracion.svg';
...
export const serviceRoutes = {
  ...
  children: [
    {
      name: 'Inmobiliaria',
      icon: inmobiliariaImg,
      active: true,
    },
    {
      name: 'Vehiculos y Transportes',
      icon: logisticaYTransporteImg,
      // to: paths.chat,
      active: true,
    },
    {
      name: 'Maquinarias y Equipos',
      icon: industriaYMaquinariaImg,
      // to: paths.emailInbox,
      active: true,
    },
    {
      name: 'Tecnología y Electrónica',
      icon: inversionesYFinanzasImg,
      // to: paths.emailDetail,
      active: true,
    },
    {
      name: 'Consumo y Estilo de vida',
      icon: publicidadYMarketingImg,
      // to: paths.emailCompose,
      active: true,
    },
    {
      name: ' Inversiones y Finanzas',
      icon: comercioYProductosImg,
      // to: paths.emailCompose,
      active: true,
    },
  ],
...
export const othersRoutes = {
  ...
  children: [
    {
      name: 'Soporte',
      icon: atencionAlClienteImg,
      to: paths.support,
      active: true,
    },
    {
      name: 'Configuración',
      icon: configuracionImg,
      active: true,
    },
  ],
};
