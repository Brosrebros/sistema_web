...
import img1 from 'assets/icons/mainpage-notification1.png';
import img2 from 'assets/icons/mainpage-notification2.png';
import img3 from 'assets/icons/mainpage-notification3.png';
import img4 from 'assets/icons/mainpage-notification4.png';
...
export const intelligence = [
  ...
  {
    title: 'Casas en estreno',
    icon: img2,
    description:
      ' Explora viviendas recien construidas, listas para mudarte y con acabados modernos',
  },
  {
  ...
  {
    title: ' Terrenos para construir tu hogar',
    icon: img4,
    description:
      'Encuentra terrenos urbanos y rurales ideales para proyectos personales o inversión',
  },
];
